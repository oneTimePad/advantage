...
def run_outer_loop():
    ...
    with epg_graph.as_default():
        ...
        with tf.Session() as sess:
            ...
            with open("Hopper-v1" + "-epg_loss_params.pkl", "rb") as f:
                loss_es_params_values = pickle.load(f)#(loss_es_params_values, f, pickle.HIGHEST_PROTOCOL)
